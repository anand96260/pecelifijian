...
<div data-role="page" id="home" data-theme="c">
  ...
  <a href="about.php" data-role="button" data-mini="true">About</a>
  </section>
       
    <footer data-role="footer" data-position="fixed">
        <div data-role="navbar">
		<ul>
		    <li><a href="#" data-icon="icon-home icon-white" data-theme="c" class="ui-btn-active">Home</a></li>
			<li><a href="videos.php" data-icon="icon-film icon-white">Videos</a></li>
            <li><a href="books.php" data-icon="icon-book icon-white">Fijian bible</a></li>
