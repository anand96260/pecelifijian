...
<div data-role="page" id="books" data-theme="c">
	...
	<ul data-role="listview">
			<li><a href="book1chapters.php">
			   <img src="images/images.jpg" />
				<h3>VOLA NI SERE</h3>
				<p>YAMEQU me udolu mai,<br/>
                 Me’u seretaka tu<br/>
                 Na i Vakabula dau dokai,<br/>
                 Karisito Jisu</p>
				</a></li>
			<li><a href="book2chapters.php">
			   <img src="images/images1.jpg" />
				<h3>A I VOLA TABU</h3>
				<p>Sa volai kina<br/>
				Na veiyalayalati MAKAWA<br/>
				Kei na veiyalayalati vou <br/>
		...
		<ul>
            ...
            <li><a href="books.php" data-icon="icon-book icon-white" data-theme="c" class="ui-btn-active">fijian bible</a></li>
			<li><a href="live.html" data-icon="icon-facetime-video icon-white">Live</a></li>
		</ul>
		</div>
    </footer>
